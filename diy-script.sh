...
# 修改本地时间格式
# sed -i 's/os.date()/os.date("%a %Y-%m-%d %H:%M:%S")/g' feeds/luci/modules/luci-base/luasrc/view/base.htm

# 修改版本为编译日期
date_version=$(date +"%y.%m.%d")
sed -i "s/DISTRIB_REVISION=.*/DISTRIB_REVISION='R${date_version} by Haiibo'/g" package/base-files/files/etc/openwrt_release
